...
exports.sendDocumentoFirmaEmail = exports.sendEntregaEppEmail = exports.sendActaRecargaCompletadaEmail = exports.sendActaRecargaEmail = exports.sendAsistenciaEmail = exports.sendReservationEmail = exports.sendMail = void 0;
...
const sendEntregaEppEmail = async (to, nombreFirmante, data) => {
    // Parsear la fecha manualmente para evitar el bug de UTC offset
    // new Date('YYYY-MM-DD') interpreta como UTC, lo que en Colombia (UTC-5) desplaza un día atrás
    const [yearF, monthF, dayF] = String(data.fecha).split('-');
    const fechaLocal = new Date(Number(yearF), Number(monthF) - 1, Number(dayF));
...
exports.sendEntregaEppEmail = sendEntregaEppEmail;
// ==================== EMAIL DE FIRMA DE DOCUMENTO ====================
const sendDocumentoFirmaEmail = async (to, nombreFirmante, data) => {
    const styles = {
        container: `
      font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
      max-width: 600px;
...
exports.sendDocumentoFirmaEmail = sendDocumentoFirmaEmail;
